...
export default function CardProduto({ produto, onAdicionar, onVerDetalhes }) {
  return (
    <article className="bg-white rounded-2xl shadow-md hover:shadow-2xl transition-all overflow-hidden group relative">
      {/* Badge de promoção */}
      {produto.promocao && (
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-4 py-2 rounded-full hover:shadow-lg transition-all flex items-center gap-2 text-sm font-semibold hover:scale-105"
